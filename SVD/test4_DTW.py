...
#dtwvis.plot_warping(data_1[0,20,:], data_1[40,20,:], path = dtw.warping_path (data_1[0,20,:], data_1[40,20,:] ) )


#fastdtw

#distance, path = fastdtw(data_1[0,20,:], data_1[40,20,:], dist = euclidean)
distance, path = fastdtw(data_1[0,20,:], data_1[40,20,:])
